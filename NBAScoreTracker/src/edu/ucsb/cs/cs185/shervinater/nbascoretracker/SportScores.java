...
public class SportScores extends Activity {
	...
	public static class EnterGameFragment extends DialogFragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			final String[] teamNames = getResources().getStringArray(R.array.teams_array);
	        ArrayAdapter<String> teams = new ArrayAdapter<String>(getActivity(),
	        		android.R.layout.simple_list_item_1, teamNames);
	        AutoCompleteTextView team1 = (AutoCompleteTextView) view.findViewById(R.id.name1);
	        AutoCompleteTextView team2 = (AutoCompleteTextView) view.findViewById(R.id.name2);
	        team1.setAdapter(teams);
	        team1.setThreshold(1);
	        team2.setAdapter(teams);
	        team2.setThreshold(1);
